...
const PrivacyPolicy = () => {
    const documentUrl = process.env.NODE_ENV === 'production' ? 'https://www.nespecialists.com/UnityMSKPrivacyPolicy.docx' : 'http://localhost:3001/UnityMSKPrivacyPolicy.docx';
