class ApplicationController < ActionController::Base
  ...
  def cors_set_access_control_headers
    allowed_origins = ['https://northwest-extremity-specialist-1660e5326280.herokuapp.com']
  ...
  def cors_preflight_check
    ...
    allowed_origins = ['https://northwest-extremity-specialist-1660e5326280.herokuapp.com'] # Add any additional allowed origins as needed
